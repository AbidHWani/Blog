...
app.get("/posts/:id", (req,res)=>{
  ...
  if(!post) return(res.status(404).json({message:`Sorry, post with id ${id} not found`}));
  res.render("post",{
    title:post.title,
...
app.get("/edit/:id", async (req, res) => {
  ...
  try {
    // Assuming you are rendering a view for editing
    res.render("modify.ejs", {
      heading: "Edit Post",
      submit: "Update Post",
      post: post, // Corrected from post: p
    });
  } catch (error) {
